...
export default function RelatedArticleCard({ article }) {
  return (
    <Link to={`/article/${article.id}`}>
      <div className="bg-[#1E1F22] p-3 rounded-lg overflow-hidden shadow-lg flex sm:flex-row flex-col gap-3 justify-between hover:bg-[#2a2b30] transition-colors">
        <img
          src={article.imageUrl}
          alt={article.title}
          className="w-[311px] h-[237px] sm:w-33 sm:h-35 object-cover rounded"
        />
