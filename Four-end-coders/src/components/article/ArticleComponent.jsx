  ...
  return (
    <div style={{ backgroundColor: "#000000" }}>
      ...
      <div className="flex flex-col">
        {(filter === 'all' || filter === 'broadway') && broadway.length > 0 && <Broadway broadway={broadway} />}
        {(filter === 'all' || filter === 'musical') && musical.length > 0 && <Musical musical={musical} />}
        {(filter === 'all' || filter === 'ballet') && ballet.length > 0 && <Ballet ballet={ballet} />}
