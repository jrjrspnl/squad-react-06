        ...
        <div className="">
            {/* Broadway Card */}
                <div className="flex flex-row justify-between mx-5">
                    ...
                    <div className="text-white">
                        <select className="text-white bg-slate-900 py-2 px-2 border-0" id="cars" onClick={handleClick}>
                            <option className="text-white" value="">All</option>
                            <option className="text-white" value="broadway">broadway</option>
                            <option className="text-white" value="musical">musical</option>
                            <option className="text-white" value="ballets">ballets</option>
                        </select>
                    </div>
                </div>
                <div className="" >
...
const ArticlesLayout = () => {
  ...
  return (
    <div className="" style={{backgroundColor: "#000000"}}>
        <ArticleCategory  broadway={broadWays} musical={musicals} ballets={ballets}/>
    </div>
  );
};
